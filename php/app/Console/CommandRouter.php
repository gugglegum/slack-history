...
class CommandRouter
{
    ...
    public static array $commands = [
        \App\Console\Commands\FetchHistoryCommand::class => 'Fetch message history from Slack API into local DB',
        \App\Console\Commands\FetchFilesCommand::class => 'Fetch files attached to messages from Slack API into local folder',
        \App\Console\Commands\CompileHtmlCommand::class => 'Render chats from DB into HTML files',
